Ifyouarereadingthisitstoolatecoin Core version *0.15.1* is now available from:

  <https://download.ifyouarereadingthisitstoolatecoin.org/ifyouarereadingthisitstoolatecoin-0.15.1/>
...
A number of changes to the way Ifyouarereadingthisitstoolatecoin Core deals with peer connections and invalid blocks
