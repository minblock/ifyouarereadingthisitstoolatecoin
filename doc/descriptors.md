# Support for Output Descriptors in Ifyouarereadingthisitstoolatecoin Core

Since Ifyouarereadingthisitstoolatecoin Core v0.17, there is support for Output Descriptors. This is a
...
on Ifyouarereadingthisitstoolatecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Ifyouarereadingthisitstoolatecoin Core wallets, a convenience function `combo` is
