...
These are the dependencies currently used by Ifyouarereadingthisitstoolatecoin Core. You can find instructions for installing them in the `build-*.md` file for your platform.
