...
"""Verify that starting ifyouarereadingthisitstoolatecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ifyouarereadingthisitstoolatecoin with -h for help text")
        ...
        self.log.info("Start ifyouarereadingthisitstoolatecoin with -version for version information")
        ...
        self.log.info("Start ifyouarereadingthisitstoolatecoind with -fakearg to make sure it does not start")
