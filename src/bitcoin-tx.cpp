...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ifyouarereadingthisitstoolatecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ifyouarereadingthisitstoolatecoin-tx [options] <hex-tx> [commands]  Update hex-encoded ifyouarereadingthisitstoolatecoin transaction\n" +
            "or:     ifyouarereadingthisitstoolatecoin-tx [options] -create [commands]   Create hex-encoded ifyouarereadingthisitstoolatecoin transaction\n" +
            "\n";
