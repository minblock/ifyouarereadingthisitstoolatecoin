...
#if defined(NDEBUG)
# error "Ifyouarereadingthisitstoolatecoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Ifyouarereadingthisitstoolatecoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("ifyouarereadingthisitstoolatecoin-scriptch");
